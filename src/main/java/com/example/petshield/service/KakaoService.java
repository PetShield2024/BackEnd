...
import com.example.petshield.web.dto.KakaoAccountDto;
import com.example.petshield.web.dto.KakaoTokenDto;
...
public class KakaoService {
    ...
    public LoginResponseDto kakaoLogin(String kakaoAccessToken) {
        ...
        User existOwner = userRepository.findById(user.getId()).orElse(null);
        try {
            if (existOwner == null) {
